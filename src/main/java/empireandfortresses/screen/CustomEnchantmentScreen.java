...
@SuppressWarnings({ "java:S116", "java:S125", "java:S1226" })
public class CustomEnchantmentScreen extends HandledScreen<CustomEnchantmentScreenHandler> {
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        ...
        for (int k = 0; k < 3; k++) {
            ...
            if (enchantment != null) {
                if (d >= 0.0 && e >= 0.0 && d < 71.0 && e < 19.0 && this.handler.enchantmentLevel[k] <= enchantment.getMaxLevel()
                        && CustomEnchantmentHelper.getNextLevel(itemStack, enchantment) - 1 != this.handler.enchantmentLevel[k]) {
                ...
                if (d >= 72.0 && e >= 0.0 && d < 90.0 && e < 19.0
                        && (this.handler.enchantmentLevel[k] < enchantment.getMaxLevel() && this.handler.getEnchantingItemCount() >= this.handler.enchantmentMaterial[k]
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        for (int j = 0; j < 3; j++) {
            ...
            if (this.isPointWithinBounds(79, 14 + 19 * j, 69, 17, mouseX, mouseY) && enchantment != null
                    && CustomEnchantmentHelper.getNextLevel(itemStack, enchantment) - 1 != this.handler.enchantmentLevel[j]) {
